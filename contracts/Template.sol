...
contract Template is TemplateBase {
    ...
    function newInstance() public {
        ...
        bytes32 appId = keccak256(abi.encodePacked(apmNamehash("open"), keccak256("hive-template")));
    ...
    function newInstance(string _mbrName, string _mbrSymbol, string _mrtName, string mrtSymbol) public {
